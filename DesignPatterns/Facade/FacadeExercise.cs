    ...
    public class MagicSquareGenerator
    {
        public List<List<int>> Generate(int size)
        {
            ...
            do
            {
                ...
                {
                    list.Add(new Generator().Generate(size));
                }
            }
            while (new Verifier().Verify(new Splitter().Split(list)));
            
            return list;
        }
    }

    public static class FacadeExerciseInitialization
    {
        public static void FacadeExerciseInit()
        {
            var magic = new MagicSquareGenerator();
            var list = magic.Generate(3);
        }
    }
}
